...
// kr_mav_controllers/src/SO3Control.cpp，BSD-3-Clause许可（版权声明见同目录
// LICENSE-kr_mav_control）。唯一改动：#include路径从"kr_mav_controllers/
// SO3Control.hpp"改成"SO3Control.hpp"（拍平目录结构），控制律数学本身
// 一行没动。
